    ...
    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="shadow-lg transform transition-transform hover:scale-105">
          <img 
            src="logo.svg" 
            alt="Logo Balai Besar Standardisasi Pelayanan Dan Jasa Industri Tekstil" 
    ...
    {isMenuOpen && (
      ...
      >
        ...
        <div className="relative z-10 text-white text-center max-w-3xl mx-auto">
          <h2 className="text-4xl sm:text-7xl font-extrabold mb-6 leading-tight">
            Selamat Datang
            <br />
          </h2>
           <h2 className="text-4xl sm:text-4xl font-extrabold mb-6 leading-tight">
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-200 via-blue-50 to-indigo-200">
              Di Sistem informasi Pendaftaran Praktek Kerja lapangan / Magang
            </span>
            </h2>
          ...
          <p className="text-lg sm:text-xl mb-10 text-blue-100 max-w-2xl mx-auto leading-relaxed">
            ...
            <strong className="text-white"> Balai Besar Standardisasi Dan Pelayanan Jasa Industri Tekstil</strong>. 
      ...
      <footer className="bg-gray-900 text-gray-300 py-12">
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-2xl mx-auto">
            <h4 className="text-2xl font-bold text-white mb-4">Balai Besar Standardisasi Dan Pelayanan Jasa Industri Tekstil</h4>
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
              Jl. A. Yani No.390, Kebonwaru, Kec. Batununggal, Kota Bandung, Jawa Barat 40272<br />
              Email: Subtimumumbbt@gmail.com | Telp: (022) 7206214
            </p>
            <div className="border-t border-gray-800 pt-6">
              <p className="text-gray-500 text-xs">
                &copy; {new Date().getFullYear()} Balai Besar Standardisasi Dan Pelayanan Jasa Industri Tekstil. 
                All rights reserved.
              </p>
            </div>
          </div>
